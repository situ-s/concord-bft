...
std::unique_ptr<TestSetup> TestSetup::ParseArgs(int argc, char** argv) {
  ...
  try {
    ...
    static struct option longOptions[] = {
        ...
        {"unified-certificates", optional_argument, 0, 'U'},
    ...
    while ((o = getopt_long(
      ...
      switch (o) {
        ...
        case 'U': {
          ...
          replicaConfig.useUnifiedCertificates = unified_cert;
          LOG_INFO(GL, "SS--unified certs" << replicaConfig.useUnifiedCertificates);
          break;
        }
        case '?': {
